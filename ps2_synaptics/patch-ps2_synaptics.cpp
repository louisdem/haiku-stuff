--- /boot/home/src/src/add-ons/kernel/bus_managers/ps2/ps2_synaptics.cpp.orig	2012-05-31 11:10:18.485228544 +0400
+++ /boot/home/src/src/add-ons/kernel/bus_managers/ps2/ps2_synaptics.cpp	2012-05-31 11:24:24.702021632 +0400
@@ -29,6 +29,13 @@
...
@@ -57,6 +64,8 @@ send_touchpad_arg_timeout(ps2_dev *dev, 
 {
 	...
 	uint8 val[8];
+
+	ps2_dev_command_timeout(dev, 0xE6, NULL, 0, NULL, 0, timeout / 7);
 	for (i = 0; i < 4; i++) {
 		val[2 * i] = (arg >> (6 - 2 * i)) & 3;
 		val[2 * i + 1] = 0xE8;
